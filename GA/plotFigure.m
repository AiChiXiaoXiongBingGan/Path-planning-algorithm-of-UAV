function [p3,p4,p5] = plotFigure(startPos,goalPos,X,Y,Z, GlobalBest,h_ocean,x_radar,y_radar,z_radar,x_H_gun,y_H_gun,z_H_gun)
...
hold on
mesh(x_H_gun,y_H_gun,z_H_gun,'FaceAlpha',0.5) % 画雷达模型
